...
use super::Task;
use self::schedule_tree::ScheduleTree;
...
impl<'a> Schedule<'a> {
    ...
    pub fn schedule_according_to_importance<'b: 'a, I>(tasks: I) -> Result<Schedule<'a>>
        where I: IntoIterator<Item=&'b Task>
    {
    ...
    pub fn schedule_according_to_myrjam<'b: 'a, I>(tasks: I) -> Result<Schedule<'a>>
        where I: IntoIterator<Item=&'b Task>
    {
        let mut tree = ScheduleTree::new();
        // Make sure things aren't scheduled before the algorithm is finished.
